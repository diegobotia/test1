...
import com.udea.app.domain.BorrowedBook;
import com.udea.app.repository.BorrowedBookRepository;
import com.udea.app.service.BorrowedBookQueryService;
import com.udea.app.service.BorrowedBookService;
import com.udea.app.service.criteria.BorrowedBookCriteria;
...
/**
 * REST controller for managing {@link com.udea.app.domain.BorrowedBook}.
 */
@RestController
@RequestMapping("/api")
public class BorrowedBookResource {
    ...
    public ResponseEntity<BorrowedBook> partialUpdateBorrowedBook(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, borrowedBook.getId().toString())
        );
    }
